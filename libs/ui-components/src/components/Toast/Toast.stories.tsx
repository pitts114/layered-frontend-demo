...
export const Info: Story = {
  args: { variant: 'info', title: 'Info', children: 'This is an info toast.' },
};
export const Success: Story = {
  args: { variant: 'success', title: 'Success', children: 'Operation completed!' },
};
export const Warning: Story = {
  args: { variant: 'warning', title: 'Warning', children: 'Please be careful.' },
};
...
export const Dismissible: Story = {
  args: {
    variant: 'success',
    children: 'This toast can be dismissed.',
