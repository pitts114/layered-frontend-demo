    ...
    <div className="w-full">
      <div className="flex items-start">
        <input
          ...
          id={radioId}
          disabled={disabled}
          className={`w-4 h-4 mt-0.5 text-blue-600 border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 focus:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50 ${className}`}
          {...props}
        />
        {label && (
